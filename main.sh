...
clear;clear;clear
echo -e "${BlueBee}╔════════════════════════════════════════════════╗${NC}"
echo -e "\033[96;1m                R32WRTxTUNNELING               \033[0m"
echo -e "${BlueBee}╚════════════════════════════════════════════════╝${NC}"
echo ""
...
echo -e " \e[93;1m•\e[0m VMESS = MUKytIPATCH / MUKytIPORT / GRPC / TLS / WS "
echo -e " \e[93;1m•\e[0m VLESS = MUKytIPATCH / MUKytIPORT / GRPC / TPS / WS "
echo -e " \e[93;1m•\e[0m TROJAN = MUKytIPATCH / MUKytIPORT / GRPC / TLS / WS+SSL "
echo -e " \e[93;1m•\e[0m SSR = MUKytIPATCH / MUKytIPORT / GRPC / TLS "
echo -e " \e[93;1m•\e[0m NOOBVPNS = MUKytIPORT / WS / SSL "
echo -e ""
echo -e "\e[94;1m╔═════════════════════════════════════════════════╗\e[0m"
